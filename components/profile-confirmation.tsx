    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
      ...
      <div className="relative z-10 max-w-lg w-full bg-[#1a1a1a] rounded-2xl p-6 border border-gray-800">
        ...
        <p className="text-white text-center mb-6">
          Você deseja espionar o perfil <span className="font-semibold">@{profileData.username}</span>?
        </p>
        ...
        <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4 mb-6 flex gap-3">
          ...
          <p className="text-red-400 text-sm">
            <span className="font-semibold">Aviso:</span> Limite de apenas 1 pesquisa por dispositivo, certifique-se que
            digitou o usuário corretamente.
          </p>
        </div>
